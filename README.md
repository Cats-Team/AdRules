...
## 规则总数
```
更新时间: 2022-04-22 20:18:58 （北京时间） 

AdRules（For AdBlock）规则数量: 90671 

AdRules（For AdGuard）规则数量: 107663 

AdRules（For DNS）规则数量: 95681 

AdRules（For Adaway）规则数量: 121547 

AdRules Allowlist 规则数量: 18019 

AdRules Ad Domains List 数量: 121547 

AdRules AdBlock Full List 规则数量: 240176 
