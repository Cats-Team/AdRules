...
## 规则总数
```
更新时间: 2022-04-23 00:39:25 （北京时间） 

AdRules（For AdBlock）规则数量: 90709 

AdRules（For AdGuard）规则数量: 107742 

AdRules（For DNS）规则数量: 95722 
...
AdRules AdBlock Full List 规则数量: 240250 

AdRules AdGuard Full List 规则数量: 192527 
``` 
## 说明
