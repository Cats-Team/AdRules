...
## 规则总数
```
更新时间: 2022-05-04 13:04:58 （北京时间） 

AdRules（For AdBlock）规则数量: 91343 

AdRules（For AdGuard）规则数量: 108039 

AdRules（For DNS）规则数量: 127785 

AdRules（For Adaway）规则数量: 156126 

AdRules Allowlist 规则数量: 18014 

AdRules Ad Domains List 数量: 156126 

AdRules AdBlock Full List 规则数量: 241281 

AdRules AdGuard Full List 规则数量: 193081 
``` 
## 说明
