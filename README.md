...
## 规则总数
```
更新时间: 2022-04-16 11:58:43 （北京时间） 

AdRules（For AdBlock）规则数量: 90525 

AdRules（For AdGuard）规则数量: 107243 

AdRules（For DNS）规则数量: 119356 

AdRules（For Adaway）规则数量: 122843 

AdRules Allowlist 规则数量: 17904 

AdRules Ad Domains List 数量: 122843 

AdRules AdBlock Full List 规则数量: 239041 

AdRules AdGuard Full List 规则数量: 191546 
``` 
## 说明
