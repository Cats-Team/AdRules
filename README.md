...
## 规则总数
```
更新时间: 2022-04-22 23:59:08 （北京时间） 

AdRules（For AdBlock）规则数量: 90710 

AdRules（For AdGuard）规则数量: 107700 

AdRules（For DNS）规则数量: 95723 

AdRules（For Adaway）规则数量: 121553 

AdRules Allowlist 规则数量: 18026 

AdRules Ad Domains List 数量: 121553 

AdRules AdBlock Full List 规则数量: 240211 
