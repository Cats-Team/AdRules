...
## 规则总数
```
更新时间: 2022-04-21 00:50:03 （北京时间） 

AdRules（For AdBlock）规则数量: 90726 

AdRules（For AdGuard）规则数量: 107690 

AdRules（For DNS）规则数量: 94130 
...
AdRules AdBlock Full List 规则数量: 239781 

AdRules AdGuard Full List 规则数量: 192228 
``` 
## 说明
