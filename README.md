...
## 规则总数
```
更新时间: 2022-04-30 20:08:17 （北京时间） 

AdRules（For AdBlock）规则数量: 91050 

AdRules（For AdGuard）规则数量: 107698 

AdRules（For DNS）规则数量: 130858 

AdRules（For Adaway）规则数量: 158190 

AdRules Allowlist 规则数量: 17986 

AdRules Ad Domains List 数量: 158190 
